...
description: >-
  ...
  skill). Also handles direct how/what/why questions in Question mode.
...
For direct Bun runtime, TypeScript/JavaScript APIs, tooling, SQL/S3/RabbitMQ integrations, and Biome/testing patterns questions (e.g. Bun APIs, bundler/test runner behavior, `bun:*` modules, SQL driver usage, performance characteristics) without a full code review, design validation, or incident investigation.
